...
export default function StudentSciencePage() {
  ...
  const [assessments, setAssessments] = useState<ScienceAssessment[]>([]);
  ...
  useEffect(() => {
    const fetchAssessments = async () => {
      setLoading(true);
      try {
        const response = await fetch(`/api/student/assessments?student_id=${studentId}&subject=science`);
  ...
  const pointsResult = calculateSubjectPoints(assessments, "science");
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: "16px", fontWeight: "700", color: "#34d399" }}>{pointsEarned}</div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        width: "100%",
        height: "100%",
        background: "linear-gradient(135deg, rgba(16, 185, 129, 0.3) 0%, rgba(5, 150, 105, 0.3) 50%, rgba(6, 95, 70, 0.2) 100%)",
        zIndex: -1,
      }} />
        ...
        {!loading && (
          <>
            ...
            <div style={{
              ...
              <div style={{ 
                ...
                <div style={{ textAlign: "center", padding: "15px", background: "rgba(16, 185, 129, 0.2)", borderRadius: "12px" }}>
                  ...
                  <div style={{ fontSize: "20px", fontWeight: "700", color: "#10b981" }}>{pointsResult.quizPoints}</div>
                </div>
                <div style={{ textAlign: "center", padding: "15px", background: "rgba(5, 150, 105, 0.2)", borderRadius: "12px" }}>
                  <div style={{ fontSize: "11px", color: "rgba(255, 255, 255, 0.6)", marginBottom: "4px" }}>📋 Unit Tests</div>
                  <div style={{ fontSize: "20px", fontWeight: "700", color: "#059669" }}>{pointsResult.unitTestPoints}</div>
                </div>
                <div style={{ textAlign: "center", padding: "15px", background: "rgba(6, 95, 70, 0.2)", borderRadius: "12px" }}>
                  <div style={{ fontSize: "11px", color: "rgba(255, 255, 255, 0.6)", marginBottom: "4px" }}>🎯 FAST PM</div>
                  <div style={{ fontSize: "20px", fontWeight: "700", color: "#065f46" }}>{pointsResult.fastPmPoints}</div>
                </div>
                <div style={{ textAlign: "center", padding: "15px", background: "rgba(52, 211, 153, 0.2)", borderRadius: "12px" }}>
                  <div style={{ fontSize: "11px", color: "rgba(255, 255, 255, 0.6)", marginBottom: "4px" }}>⭐ STAR</div>
                  <div style={{ fontSize: "20px", fontWeight: "700", color: "#34d399" }}>{pointsResult.starPoints}</div>
                </div>
              </div>
            ...
            <div style={{
              ...
              <AssessmentBarChart data={quizzes} title="Quizzes" icon="📝" color="#10b981" pointsEarned={pointsResult.quizPoints} />
              <AssessmentBarChart data={unitTests} title="Unit Tests" icon="📋" color="#059669" pointsEarned={pointsResult.unitTestPoints} />
              <AssessmentBarChart data={fastTests} title="FAST PM" icon="🎯" color="#065f46" isScaleScore pointsEarned={pointsResult.fastPmPoints} />
              <AssessmentBarChart data={starTests} title="STAR" icon="⭐" color="#34d399" isScaleScore pointsEarned={pointsResult.starPoints} />
            </div>
