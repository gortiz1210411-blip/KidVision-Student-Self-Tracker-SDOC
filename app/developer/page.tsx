export default function DeveloperPageDisabled() {
  return (
    <main
      style={{
        minHeight: "100vh",
    ...
    >
      ...
      >
        ...
        <p style={{ margin: 0, lineHeight: 1.6, color: "rgba(248,250,252,0.82)" }}>
          This route is intentionally disabled in the review-ready repository. Teacher-management and developer-only tooling are not part of the district review surface.
        </p>
      </section>
    </main>
  );
